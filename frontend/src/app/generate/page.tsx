        ...
        {hasManual === false && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-center">
            ...
            <p className="text-xs text-amber-600 mb-4">
              Necesitas crear el manual primero para que la IA pueda generar contenido alineado con tu marca.
            </p>
            <Link
              href="/brand-manual"
              className="inline-block bg-amber-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-amber-500 transition-all"
            >
